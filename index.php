    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="saisir/devoir"><i class="fa fa-link"></i> <span>Ajouter un devoir</span></a>
                </li>
                <li class="header">Consulation</li>
                <li><a href="#"><i class="fa fa-link"></i> <span>Tous les Devoirs</span></a></li>
